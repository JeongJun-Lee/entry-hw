...
(function (HardwareStatement) {
    ...
    HardwareStatement["compile"] = "compile";
...
/*!*******************************************!*\
  !*** ./app/src/preload/translations.json ***!
  \*******************************************/
/*! exports provided: en, If unexpected problem occurs while operating,, contact the hardware company to resolve the problem., * Entry Labs is not responsible for the extension program and hardware products on this site., Choose a hardware to connect., Have you installed the device driver?, Install Device Driver, Install Firmware, Possible Install Firmware, Install Firmware(Sensor Board), Install Firmware(Sensor Board Bluetooth), Install Firmware(Extension Project), Hardware Device Is Not Connected, Connect Other Hardware, Show Entry Web Page, Reconnect Hardware, Select hardware, Version Info, Firmware Uploaded!, Failed Firmware Upload, Firmware Uploading..., hardware > connecting, hardware > connected, hardware > disconnected, hardware > connection failed, Connecting to hardware device., Connected to hardware device., Connection failed. please restart application or reconnect manually., Hardware device is disconnected. Please restart this program., Connection to the hardware will terminate once program is closed., Copied to clipboard, Select, Select the COM PORT to connect, Cancel, Connect, Arduino compatible driver, Bluetooth driver, No results found, Do you want to restart the program?, Please select the firmware., Opensource lincense, Close, You are running the latest version., Download the latest version, You can use the latest Entry Hardware version(%1)., Alert, Download, Please enter a value for hardware connection., Please enter a valid value., Please wait until the hardware is connected., Set, Reset, Connected to the Entry server, Disconnected from the Entry server, Compile failed. please check your source code and Entry console, Firmware Install Guide, default */
/***/ (function(module) {

module.exports = JSON.parse("{\"en\":{\"en-GB\":\"en\",\"en-US\":\"en\",\"ko\":\"ko\",\"uz\":\"uz\",\"ru\":\"ru\"},\"If unexpected problem occurs while operating,\":{\"ko\":\"하드웨어 연결과 작동 시 예기치 못한 문제가 발생할 수 있습니다.\",\"jp\":\"ハードウェア接続においてエラーが発生した場合は、\",\"uz\":\"Qurilmani ulashda kutilmagan muammo paydo bo'lish mumkin.\",\"ru\":\"При подключении и эксплуатации оборудования могут возникнуть неожиданные проблемы.\"},\"contact the hardware company to resolve the problem.\":{\"ko\":\"문제 발생 시 해당 하드웨어 업체에 문의해주세요.\",\"jp\":\"ハードウェアの製造元に問い合わせてください。\",\"uz\":\"Agar muammo paydo bo'lsa qurilma korxonaga murojaat qilish mumkin.\",\"ru\":\"В случае возникновения проблемы обратитесь к производителю оборудования.\"},\"* Entry Labs is not responsible for the extension program and hardware products on this site.\":{\"ko\":\"* 하드웨어 연결 프로그램에 등록된 하드웨어들은 각 업체가 제공하고 개발한 것이며, 엔트리는 본 프로그램 이외에는 책임지지 않습니다.\",\"jp\":\"※ハードウェアは各製造元が開発・提供するものであり、LINE株式会社はLINE entryのプログラム以外に責任を負いませんので、ご了承ください。\",\"uz\":\"* Qurilma bo'yicha bloklari har qurilma korxonalardan yaratilgan edi. Entry u bloklar haqida ma’suliyatdan ozod bo'ladi.\",\"ru\":\"* Entry Labs не несет ответственности за программные и аппаратные продукты расширения на этом сайте.\"},\"Choose a hardware to connect.\":{\"ko\":\"연결할 하드웨어를 선택해 주세요.\",\"jp\":\"接続させたいハードウェアを選択してください\",\"uz\":\"Ulamoqchi qurilmani tanlab bering\",\"ru\":\"Пожалуйста, выберите оборудование для подключения.\"},\"Have you installed the device driver?\":{\"ko\":\"디바이스 드라이버를 설치하셨나요?\",\"jp\":\"デバイスのドライバをインストールしましたか\",\"uz\":\"Drayver o'rnatuvchi o'rnatganmisiz?\",\"ru\":\"Вы установили драйвер устройства?\"},\"Install Device Driver\":{\"ko\":\"드라이버 설치\",\"jp\":\"ドライバ・インストール\",\"uz\":\"Drayver o'rnatuvchi o'rnatish\",\"ru\":\"Установка драйвера\"},\"Install Firmware\":{\"ko\":\"펌웨어 설치\",\"jp\":\"ファームウェア・インストール\",\"uz\":\"Qurilma kichik dasturi o'rnatish\",\"ru\":\"Установка прошивки\"},\"Possible Install Firmware\":{\"ko\":\"펌웨어 설치 가능\",\"jp\":\"ファームウェア・インストール可能\"},\"Install Firmware(Sensor Board)\":{\"ko\":\"센서/확장보드 유선 펌웨어\",\"jp\":\"センサ／拡張ボードの有線ファームウェア\"},\"Install Firmware(Sensor Board Bluetooth)\":{\"ko\":\"센서/확장보드 무선 펌웨어\",\"jp\":\"センサ／拡張ボードの無線ファームウェア\"},\"Install Firmware(Extension Project)\":{\"ko\":\"펌웨어 설치(확장프로젝트)\",\"jp\":\"ファームウェア・インストール（拡張プロジェクト）\"},\"Hardware Device Is Not Connected\":{\"ko\":\"하드웨어 장치가 아직 연결되지 않았습니다.\",\"jp\":\"ハードウェア装置がまだ接続されていません\"},\"Connect Other Hardware\":{\"ko\":\"다른 하드웨어 연결\",\"jp\":\"他のハードウェアを接続する\"},\"Show Entry Web Page\":{\"ko\":\"엔트리 웹 페이지 보이기\",\"jp\":\"LINE entryのWEBサイトへ\"},\"Reconnect Hardware\":{\"ko\":\"하드웨어 다시 연결\",\"jp\":\"ハードウェアにもう一度接続する\"},\"Select hardware\":{\"ko\":\"하드웨어 선택\",\"jp\":\"ハードウェアを選択\",\"uz\":\"Qurilma tanlash\",\"ru\":\"Выберите оборудование\"},\"Version Info\":{\"ko\":\"버전 정보\",\"jp\":\"バージョン情報\"},\"Firmware Uploaded!\":{\"ko\":\"펌웨어가 업로드 되었습니다.\",\"jp\":\"ファームウェアがアップロードされました\",\"uz\":\"Qurilma kichik dasturi yuklab qo'yish yaxshi tugagan.\",\"ru\":\"Загрузка прошивки завершена\"},\"Failed Firmware Upload\":{\"ko\":\"펌웨어 업로드가 실패하였습니다.\",\"jp\":\"ファームウェアのアップロードに失敗しました\",\"uz\":\"Qurilma kichik dasturi yuklab qo'yish bo'lmadi.\",\"ru\":\"Не удалось загрузить прошивку устройства.\"},\"Firmware Uploading...\":{\"ko\":\"펌웨어 업로드 중입니다...\",\"jp\":\"ファームウェアのアップロード中...\",\"uz\":\"Qurilma kichik dasturi yuklab qo'ymoqda...\",\"ru\":\"Загрузка прошивки ...\"},\"hardware > connecting\":{\"ko\":\"하드웨어 > 연결 대기\",\"jp\":\"ハードウェア > 待機中\",\"uz\":\"Qurilma > Ulash kutmoqda\",\"ru\":\"аппаратное обеспечение> подключение\"},\"hardware > connected\":{\"ko\":\"하드웨어 > 연결 성공\",\"jp\":\"ハードウェア > 接続完了\",\"uz\":\"Qurilma > Ulangan\",\"ru\":\"аппаратное обеспечение> подключено\"},\"hardware > disconnected\":{\"ko\":\"하드웨어 > 연결 끊김\",\"jp\":\"ハードウェア > 接続解除\",\"uz\":\"Qurilma > Ulash uzilgan\",\"ru\":\"аппаратное обеспечение > отключено\"},\"hardware > connection failed\":{\"ko\":\"하드웨어 > 연결 실패\",\"jp\":\"ハードウェア > 接続失敗\",\"uz\":\"Qurilma > Ulash bo'lmagan\",\"ru\":\"аппаратное обеспечение > ошибка подключения\"},\"Connecting to hardware device.\":{\"ko\":\"하드웨어와 연결을 시도하고 있습니다.\",\"jp\":\"ハードウェア接続：待機中\",\"uz\":\"Qurilmaga ulanmoqda\",\"ru\":\"Подключение к аппаратному устройству.\"},\"Connected to hardware device.\":{\"ko\":\"하드웨어와 연결되었습니다.\",\"jp\":\"ハードウェア接続完了\",\"uz\":\"Qurilmaga ulangan\",\"ru\":\"Подключено к аппаратному устройству.\"},\"Connection failed. please restart application or reconnect manually.\":{\"ko\":\"하드웨어 연결에 실패했습니다. 연결을 재시도하거나 프로그램을 재실행해주세요.\",\"jp\":\"ハードウェアの接続に失敗しました。接続を再試行するか、プログラムを再実行してください。\",\"uz\":\"Qurilmaga ulash bo'lmagan. Yana urinish yoki dasturni qaytadan ishga tushiring.\",\"ru\":\"Не удалось подключиться к оборудованию. Пожалуйста, повторите попытку подключения или перезапустите программу.\"},\"Hardware device is disconnected. Please restart this program.\":{\"ko\":\"하드웨어 연결이 끊어졌습니다. 연결 프로그램을 다시 시작해 주세요.\",\"jp\":\"ハードウェアとの接続が解除されました。接続ソフトを再起動してください。\",\"uz\":\"Qurilma bilan ulangani uzilgan. Ulash dasturini qaytadan ishga tushiring.\"},\"Connection to the hardware will terminate once program is closed.\":{\"ko\":\"프로그램 종료 시 하드웨어와 연결이 끊어집니다.\",\"jp\":\"プログラムが終了するとハードウェアとの接続が解除されます。\",\"uz\":\"Bu dasturni o'chirishda qurilma bilan ulangani uziladi.\",\"ru\":\"При завершении программы связь с оборудованием теряется.\"},\"Copied to clipboard\":{\"ko\":\"이메일 주소가 복사되었습니다.\",\"jp\":\"メールアドレスがコピーされました\"},\"Select\":{\"ko\":\"선택하세요\",\"jp\":\"選択\",\"uz\":\"Tanlash\",\"ru\":\"Выбрать\"},\"Select the COM PORT to connect\":{\"ko\":\"연결할 COM PORT를 선택하세요\",\"jp\":\"接続するCOM PORTを選択してください\",\"uz\":\"KOM-portni tanlab bering\",\"ru\":\"Выберите COM-порт для подключения\"},\"Cancel\":{\"ko\":\"취소\",\"jp\":\"キャンセル\",\"uz\":\"Bekor qilish\",\"ru\":\"отменить\"},\"Connect\":{\"ko\":\"연결\",\"jp\":\"接続する\",\"uz\":\"Ulash\",\"ru\":\"соединить\"},\"Arduino compatible driver\":{\"ko\":\"아두이노 호환보드 드라이버\",\"jp\":\"Arduino互換ボードドライバ\"},\"Bluetooth driver\":{\"ko\":\"블루투스 동글 드라이버\",\"jp\":\"Bluetooth ドングルドライバ\"},\"No results found\":{\"ko\":\"검색 결과가 없습니다.\",\"jp\":\"検索結果がありません\"},\"Do you want to restart the program?\":{\"ko\":\"프로그램을 재시작 하시겠습니까?\",\"jp\":\"プログラムを再起動させますか？\"},\"Please select the firmware.\":{\"ko\":\"펌웨어를 선택해 주세요.\",\"jp\":\"ファームウェアを選択してください。\",\"uz\":\"Qurilma kichik dasturini o'rnating.\",\"ru\":\"Пожалуйста, выберите прошивку.\"},\"Opensource lincense\":{\"ko\":\"오픈소스 라이선스\",\"jp\":\"オープンソースライセンス\"},\"Close\":{\"ko\":\"닫기\",\"jp\":\"閉じる\"},\"You are running the latest version.\":{\"ko\":\"최신 버전입니다.\",\"jp\":\"最新バージョンです。\"},\"Download the latest version\":{\"ko\":\"최신버전 다운로드\",\"jp\":\"最新バージョンをダウンロード\"},\"You can use the latest Entry Hardware version(%1).\":{\"ko\":\"엔트리 하드웨어 새 버전(%1)을\\n사용하실 수 있습니다.\",\"jp\":\"エントリーハードウェアの最新バージョン(%1)を\\nご使用いただけます。\"},\"Alert\":{\"ko\":\"업데이트 알림\",\"jp\":\"アップデート通知\"},\"Download\":{\"ko\":\"최신 버전 다운로드\",\"jp\":\"今すぐアップデート\"},\"Please enter a value for hardware connection.\":{\"ko\":\"하드웨어 연결을 위한 값을 입력해 주세요.\",\"jp\":\"ハードウェアを接続するための値を入力してください。\"},\"Please enter a valid value.\":{\"ko\":\"올바른 값을 입력해 주세요.\",\"jp\":\"正しい値を入力してください。\"},\"Please wait until the hardware is connected.\":{\"ko\":\"하드웨어가 연결될 때까지 잠시 기다려 주세요.\",\"jp\":\"ハードウェアが接続されるまでしばらくお待ちください。\"},\"Set\":{\"ko\":\"설정\",\"jp\":\"設定\"},\"Reset\":{\"ko\":\"재설정\",\"jp\":\"再設定\"},\"Connected to the Entry server\":{\"ko\":\"엔트리 서버 연결됨\",\"jp\":\"エントリーサーバー接続\",\"uz\":\"Entry serverga ulangan\",\"ru\":\"Подключен к серверу Entry\"},\"Disconnected from the Entry server\":{\"ko\":\"엔트리 서버 연결 안 됨\",\"jp\":\"エントリーサーバー未接続\",\"uz\":\"Entry serverga ulanmagan\",\"ru\":\"Отключился от сервера Entry\"},\"Compile failed. please check your source code and Entry console\":{\"ko\":\"컴파일 중 에러가 발생했습니다. 소스코드와 엔트리 콘솔창을 확인하세요.\",\"uz\":\"Kompilyatsiya qilishda error bor. Manba kodlari va Entry konsolni teshiring.\",\"ru\":\"Компиляция не удалась. пожалуйста, проверьте исходный код и консоль ввода\"},\"Firmware Install Guide\":{\"en\":\"For firmware installation, please connect via USB cable and select 'ArduinoExt Uno'. Wireless firmware installation is not supported.\",\"ko\":\"펌웨어 설치가 필요한 경우, USB 케이블로 연결 후 '아두이노(확장모드)'를 선택해주세요. 무선 펌웨어 설치는 지원하지 않습니다.\",\"uz\":\"Agar qurilma kichik dasturi yuklab qo'yish kerak bo'lsa, USB kabelni bog'lab <<ArduinoExt Uno>>ni tanlab o'rnating. Simsiz tarmog'ida qurilma kichik dasturi yuklab qo'yishni qo'llab-quvvatlanmaydi.\",\"ru\":\"Для установки прошивки подключитесь через USB-кабель и выберите «ArduinoExt». Беспроводная установка прошивки не поддерживается.\"}}");
...
module.exports = require("./lang/uz.js");
